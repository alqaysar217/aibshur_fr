...
const STATS = [
  { label: "إجمالي المبيعات", value: "٨٥٠,٠٠٠", currency: "ريال", icon: Wallet, trend: "+١٢.٥٪", up: true, color: "text-emerald-600", bg: "bg-emerald-50" },
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {STATS.map((stat, idx) => (
          <Card key={idx} className="border-none shadow-sm rounded-[20px] overflow-hidden hover:shadow-md transition-all group">
            ...
            <div className="h-[300px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={SALES_DATA}>
                  ...
                  />
                  <Line type="monotone" dataKey="sales" stroke="#10B981" strokeWidth={4} dot={{ r: 6, fill: '#10B981', strokeWidth: 2, stroke: '#FFF' }} activeDot={{ r: 8 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
